...
SUBDIR=$3
if  [ -z "$3" ]; then
    SUBDIR="mergedAssembly"
fi 


OUTDIR=/mnt/chr4/mikrobiomy-2/oases_${K1}_$K2/$NAME/$SUBDIR
...
DIR=$OUTDIR/kallisto_on_contigs_$L/${NAME}_${SUBDIR}_$K
...
if [ ! -f  $INDEX_FILE ]
then 
	python select_contigs.py $OUTDIR/transcripts.fa $OUTDIR/long_contigs_${L}.fa $L >> /dev/null
